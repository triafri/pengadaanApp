    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Kami memberikan kesempatan kepada UMKKM yang ingin mengajukan pengajuan barang atau jasa yang dimiliki.</h2>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Usaha Munimal 3 Tahun</a></h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Kelurahan Nagasari<br>
              Kec. Karawang Barat <br>
              Kabupaten Karawang, Jawa Barat 41312 <br><br>

              <strong>Phone:</strong> (0267) 429800 <br>
              <strong>Email:</strong> pengadaan@karawangkab.go.id <br>
            </p>
          </div>
