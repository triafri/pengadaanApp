        ...
        <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control anggaran" id="anggaran" name="anggaran" placeholder="Masukan Anggaran Pengadaan" onkeyup="currency()">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Proposal</label>
              <input type="file" class="form-control" id="proposal" name="proposal" accept="application/pdf" placeholder="">
            </div>
          </div>
          <!-- /.card-body -->
      </div>
