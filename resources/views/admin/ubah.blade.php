  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/ubahAdmin" method="post" role="form">
        ...
        <input type="hidden" class="id_admin" id="id_admin" name="id_admin">
      ...
      <div class="modal-body">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control nama" id="u_nama" name="u_nama" placeholder="Enter Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea type="text" class="form-control alamat" id="u_alamat" name="u_alamat" placeholder="Enter Address"></textarea>
            </div>
          </div>
          <!-- /.card-body -->
