          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Daftar Pengajuan Masuk</h3>
                  ...
                  <tbody>
                    @foreach($pengajuan as $p)
                      <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{asset(Storage::url($p['proposal']))}}" target="_blank">Lihat Detail</a>
                        </td>
                        <td>
                            {{number_format($p['anggaran_pengajuan'],0,",",".")}}
                        </td>
