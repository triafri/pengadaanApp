          ...
          <div class="modal-body">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea type="text" class="form-control deskripsi" id="u_deskripsi" name="u_deskripsi" placeholder="Masukan Deskripsi Pengadaan"></textarea>
              </div>
              <div class="form-group">
                <label>Anggaran : <input type="" class="labelRp" disable style="border: none; background-color: white; color: black;"></label>
                <input type="text" class="form-control anggaran" id="u_anggaran" name="u_anggaran" placeholder="Masukan Anggaran Pengadaan" onkeyup="currencyUbah()">
              </div>
            </div>
            <!-- /.card-body -->
        </div>
